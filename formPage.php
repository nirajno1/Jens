...
<form id="regForm" action="result.php">
  <h1>Refluxis Mattress Configurator</h1>
  ...
  <div class="question" >
    ...
    <p><input type="radio" name="sleepType" value="soft" checked="true"/>
        <label for="soft">Soft lying feeling</label></p>
    <p><input type="radio" name="sleepType" value="medium"/>
        <label for="medium">Medium lying feeling</label></p>
    <p><input type="radio" name="sleepType" value="Firm lying feeling"/>
        <label for="firm">Firm lying feeling</label></p>
    
  </div>
  <div class="tab"><div class="question" >Do you sweat a lot at night? *</div>
  ...
  <div class="tab"><div class="question" >How much do you weigh? *</div>
  ...
  <div class="tab">
  <div class="question" >How much would you pay for your mattress? *</div>
